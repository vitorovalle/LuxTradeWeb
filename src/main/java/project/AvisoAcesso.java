 ...
 * @author Void
 */
public class AvisoAcesso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loggerName.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        loggerName.setForeground(new java.awt.Color(25, 25, 112));
        ...
        jLabel9.setText("Você está acessando como :");

        goBackButton.setBackground(new java.awt.Color(25, 25, 112));
        goBackButton.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        goBackButton.setForeground(new java.awt.Color(255, 255, 255));
        goBackButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_Go_Back_24px.png"))); // NOI18N
        goBackButton.setText("Retornar");
        goBackButton.setBorder(null);
        goBackButton.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
