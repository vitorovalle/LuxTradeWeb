...
public class EsqueceuSenhaTela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getPasswordButton.setBackground(new java.awt.Color(25, 25, 112));
        getPasswordButton.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        ...
        getPasswordButton.setText("Enviar senha");
        getPasswordButton.setBorder(null);
        getPasswordButton.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabel10.setText("Entre com o nome do usuário");

        closeButton.setBackground(new java.awt.Color(25, 25, 112));
        closeButton.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
    ...
    private void getPasswordButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getPasswordButtonActionPerformed
        try {
            ...
            ClienteDAO.recuperarSenha(usernameField.getText());
            Principal.wrongPass = 0;
            this.dispose();
        } catch (MessagingException ex) {
            Logger.getLogger(EsqueceuSenhaTela.class.getName()).log(Level.SEVERE, null, ex);
        }        
